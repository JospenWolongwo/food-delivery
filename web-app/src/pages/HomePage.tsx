    ...
    <div className="min-h-screen">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center">
          <div className="lg:w-1/2 lg:pr-10 mb-10 lg:mb-0">
            ...
            <p className="hero-description text-lg md:text-xl mb-8">
              Connect with local food vendors and enjoy subscription-based meal
              delivery service right on your campus.
            </p>
            <div className="flex flex-col sm:flex-row gap-4">
              <Link
                to="/restaurants"
                className="hero-button btn-secondary bg-white text-indigo-600 hover:bg-gray-100"
              >
                Explore Restaurants
              </Link>
              <Link
                to="/register"
                className="hero-button btn-primary bg-orange-500 hover:bg-orange-600"
              >
                Sign Up Now
              </Link>
            </div>
          ...
          <div className="space-y-16">
            ...
            >
              <div className="md:w-1/2 mb-8 md:mb-0 md:pr-10">
                <div className="bg-indigo-100 text-indigo-600 rounded-full w-12 h-12 flex items-center justify-center text-xl font-bold mb-4">
                  1
                </div>
      ...
      <div className="bg-indigo-700 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <Link
            to="/register"
            className="bg-white hover:bg-gray-100 text-indigo-600 font-bold py-3 px-8 rounded transition-colors duration-200 text-lg"
          >
            Sign Up Now
          </Link>
        </div>

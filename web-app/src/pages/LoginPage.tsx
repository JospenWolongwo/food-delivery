...
import { useLoginMutation, useGetOAuthUrlMutation, useSocialAuthMutation } from '../store/api/authApi';
...
const LoginPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Call the login mutation from our authApi
  ...
  return (
    <div className="w-full min-h-[calc(100vh-200px)] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 bg-gray-50">

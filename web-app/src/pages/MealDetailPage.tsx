...
import { useGetMealByIdQuery, useGetRelatedMealsQuery } from '../store/api/mealsApi';
...
const mockMeal: Meal = {
  ...
  description: 'Classic Cameroonian dish made with bitter leaves, peanuts, and served with ripe plantains. This traditional meal is rich in protein and fiber, making it a nutritious choice for any time of day.',
  price: 3500,
  ...
  vendor: { 
    ...
    description: 'Authentic African cuisine prepared with love and tradition. Our recipes have been passed down through generations, bringing the true taste of Cameroon to your table.',
...
const mockRelatedMeals: Meal[] = [
  ...
  },
  {
    id: 103,
    name: 'Mbongo Tchobi',
    description: 'Spicy black stew made with a special blend of spices and served with plantains.',
    price: 4000,
...
const MealDetailPage: React.FC = () => {
  ...
  // Fetch data from API
  const { data: apiMeal, isLoading: isApiLoading, error: apiError } = useGetMealByIdQuery(mealId);
  const { data: apiRelatedMeals = [], isLoading: isApiLoadingRelated } = useGetRelatedMealsQuery(mealId, {
          ...
          <div className="border-t border-gray-200 pt-12">
            ...
            {!isLoadingRelated && relatedMeals.length > 0 ? (
              ...
              <p className="text-center text-gray-500 italic py-8">
                No related meals found. We're working on improving our recommendations.
              </p>
            )}
          </div>
        </div>
